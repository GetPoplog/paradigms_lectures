(* This file provides an implementation of a representation of sets as
unordered lists, and a partial implementation of sets as ordered lists.

You are to complete the implementation of sets as ordered lists, and
write an implementation of sets as AVL trees.
