                      ...
                      Due Thursday 6 NOV at 11:59 PM.
...
variables u,v,w, x, y, z, and your laws_power_product  function, write a
test program for checking out that your implementation of *_pp actually
satisfies the laws by running through 100 random power products. [Don't
confuse the power-product variables u,v,w.. with the the variables of the
Scheme function].
...
(3)
In algorithmic algebra, a  ________monomial is an expression of  the form (* k  p)
...
___are a commutative semigroup, write a function for creating random  monomials,
